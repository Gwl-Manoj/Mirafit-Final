...
public class Mirafirt_Remove_AllFromCart_Pom
{
	...
	@FindBy(xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[6]") private WebElement parallelbar;
	...
	@FindBy(xpath = "//select[@class='super-attribute-select']") private WebElement Choice;
	...
	@FindBy(xpath = "(//a[@class='product-item-link'])[2]") private WebElement cart;
	@FindBy(xpath = "//div[@class='stock available']") private WebElement Stock1;
	@FindBy(xpath = "//div[@class='reviews-actions']") private WebElement Reviews1;
	@FindBy(id = "attribute447") private WebElement Size;
