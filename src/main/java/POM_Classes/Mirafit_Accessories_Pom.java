...
public class Mirafit_Accessories_Pom
{
	...
	@FindBy(xpath = "(//span[@class='caret'])[12]") private WebElement Accessories;
//	@FindBy (xpath = "(//ul[@class='level0 nav-submenu nav-panel--dropdown nav-panel']//a)[70]") private WebElement ClothingAndApparel;
	@FindBy (xpath = "((//li[@class='nav-item level0 nav-5 level-top nav-item--parent classic nav-item--only-subcategories parent'])//a)[3]") private WebElement ClothingAndApparel;
	...
	@FindBy(xpath = "//div[@class='reviews-actions']") private WebElement Reviews;//a[@class='action view']
