...
import POM_Classes.Mirafit_CheckOut_Paypal_Pre_Production_Pom;
import POM_Classes.Mirafit_CheckOut_Pre_Production_Pom;

public class Mirafit_CheckOut_Paypal_Pre_Production_Test extends Mirafit_BaseClass_Pre_Production
{
	...
	Logout_Pom logout;
	Mirafit_CheckOut_Paypal_Pre_Production_Pom CheckOut;
	...
	public void OpenBrowser() throws InterruptedException
	{
		...
		CheckOut = new Mirafit_CheckOut_Paypal_Pre_Production_Pom(driver);
...
//		CheckOut.Click_Placeorder_Button();
		...
		CheckOut.Click_Cartprocedure(driver);
		
		CheckOut.Click_Checkout(driver);
		
		CheckOut.Set_MailID();
		
		CheckOut.Click_Next_Button();
